...
namespace MOPSAPI.Controllers
{
    ...
    {
        public UserController(MOPSContext dbContext,
        ...
        public MOPSContext DbContext { get; }
        ...
        {
            var userFromModel = await UserManager.FindByEmailAsync(model.email);
            ...
            if (loginResult.Succeeded)
            {
                ...
                var token = await GenerateJwtToken(model.email, appUser, false);
                return Ok(new AuthResponse
                {
