...
export class UserService {
    ...
    public updateUserPassword(currentPassword: string, passwordRequest: any): Observable<LoginResponse>{
        return this.http.put<LoginResponse>(this.appSettings.baseApiUrl + "user/me/password", new PasswordRequest(currentPassword, passwordRequest)).pipe(map(user => {
            this.currentUserSubject.next(user);
            this.SaveUserData(user);
            return user;
        }));
